...
function add_message(chatroom_ID, mssg) {
    ...
    */
    ...
    mssg_content = mssg_content.replaceAll("Bot_Neutral", "<img src='/static/images/neutral.gif' height= 50 width=50/>");
    mssg_content = mssg_content.replaceAll("Bot_Worried", "<img src='/static/images/worried.gif' height= 70 width=70/>");
    mssg_content = mssg_content.replaceAll("Bot_Relieved", "<img src='/static/images/relieved.gif' height= 70 width=70/>");
    mssg_content = mssg_content.replaceAll("Bot_Excited", "<img src='/static/images/excited.gif' height= 70 width=70/>");
    mssg_content = mssg_content.replaceAll("Bot_Happy", "<img src='/static/images/happy.gif' height= 70 width=70/>");
    mssg_content = mssg_content.replaceAll("Bot_Scared", "<img src='/static/images/scared.gif' height= 70 width=70/>");
