...
from agents1.OfficialAgentEmotion import OfficialAgentEmotion
from agents1.TutorialAgentEmotion import TutorialAgentEmotion
...
def add_agents(builder, task_type, condition, group):
    ...
    for team in range(nr_teams):
        ...
        for human_agent_nr in range(human_agents_per_team):
            ...
            # builder.add_human_agent(loc, brain, team=team_name, name='human', key_action_map=key_action_map, sense_capability=sense_capability_human, is_traversable=True, img_name="/images/human_female_smile_background.gif", visualize_when_busy=True)
            builder.add_human_agent(loc, brain, team=team_name, name='human', key_action_map=key_action_map, sense_capability=sense_capability_human, is_traversable=True, img_name="/images/human_agent_background.gif", visualize_when_busy=True)


# Create the world
def create_builder(task_type, condition, group):
    ...
    if task_type == "tutorial":
        ...
        builder.add_object(location=[9,0], is_traversable=True, name="keyboard sign", img_name="/images/keyboard-short.svg", visualize_depth=110, visualize_size=15)
    ...
    if task_type == "official":
        ...
        builder.add_object(location=[12,0], is_traversable=True, name="keyboard sign", img_name="/images/keyboard-short.svg", visualize_depth=110, visualize_size=20)
    ...
    add_agents(builder, task_type, condition, group)
